...
class AgendasListPage extends StatefulWidget {
  @override
  _AgendasListPageState createState() => _AgendasListPageState();
}
...
class _AgendasListPageState extends State<AgendasListPage> {
  ...
  void getAgendasListData() async {
    var agendasListData = await WebModel().getAgendasList();
    setState(() {
            ...
            body: Stack(
              children: [
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    var singleLine;
                    if (agendaData[index]["meeting_type"].length >= 35) {
                      var text = agendaData[index]["meeting_type"];
                      var notification = text.substring(0, 35);
                      var r = '$notification...';
                      singleLine = r.replaceAll("\n", " ");
                    } else {
                      singleLine = agendaData[index]["meeting_type"];
                    }
                    var dates = agendaData[index]["agenda_date"];
                    ...
                    return ListTile(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => AgendasItemPage(
                              agendaId: agendaData[index]["aagenda_id"],
                            ),
                          ),
                        );
                      },

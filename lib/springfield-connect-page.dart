...
class SpringfieldConnectPage extends StatefulWidget {
  @override
  _SpringfieldConnectPageState createState() => _SpringfieldConnectPageState();
}

class _SpringfieldConnectPageState extends State<SpringfieldConnectPage> {
  @override
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          title: Text('SPRINGFIELD CONNECT'),
          elevation: 0,

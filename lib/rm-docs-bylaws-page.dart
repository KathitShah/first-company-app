...
class RMDocsPage extends StatefulWidget {
  @override
  _RMDocsPageState createState() => _RMDocsPageState();
}

class _RMDocsPageState extends State<RMDocsPage> {
  @override
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          title: Text('RM DOCUMENTS & BYLAWS'),
          elevation: 0,

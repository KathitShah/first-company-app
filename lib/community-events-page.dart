import 'package:bhailu_mama_app/community-page.dart';
...
class _CommunityEventsPageState extends State<CommunityEventsPage> {
  ...
  void getCommunityData() async {
    var communities = await WebModel().getCommunities();
    setState(() {
              ...
              children: [
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    var dates =
                        communityData["data"][index]["EventStartDateTime"];
                    var noticeText = communityData["data"][index]["EventTitle"];
                    var r = noticeText;
                    if (noticeText.length > 40) {
                      noticeText = noticeText.substring(0, 32);
                      r = '$noticeText...';
                    }
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => CommunityDetailPage(
                              eventId: communityData["data"][index]["EventId"],
                              eventName: communityData["data"][index]
                                  ["EventTitle"],
                            ),
                          ),
                        );

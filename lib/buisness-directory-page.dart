...
import 'business-text-page.dart';
...
class _BusinessDirectoryPageState extends State<BusinessDirectoryPage> {
  ...
  void getBusinessData() async {
    var placesData = await WebModel().getBusiness();
    setState(() {
      businessData = placesData;
    });
  }
                ...
                return ListTile(
                    ...
                    children: [
                      Row(children: [
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              '${businessData[index]["bCategoryTitle"]}',
                            ),
                          ],
                        ),
                      ]),
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => BusinessTextPage(
                          businessId: businessData[index]["bCategoryId"],
                        ),
                      ),
                    );
                  },

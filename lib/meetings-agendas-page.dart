import 'package:bhailu_mama_app/agendas-list.dart';
import 'package:bhailu_mama_app/meetingMinute-list.dart';
...
class MeetingsAgendasPage extends StatefulWidget {
  @override
  _MeetingsAgendasPageState createState() => _MeetingsAgendasPageState();
}

class _MeetingsAgendasPageState extends State<MeetingsAgendasPage> {
  @override
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => MeetingsListPage(),
                  ),
                );
              },
              child: Container(
                ...
                child: Center(child: Text('Meeting Minutes')),
              ),
            ),
            GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => AgendasListPage(),
                  ),
                );
              },
              child: Container(
                ...
                height: MediaQuery.of(context).size.height * 0.25,
                width: double.infinity,
                child: Center(child: Text('Meeting Agendas')),
              ),
            ),
          ],
        ),
